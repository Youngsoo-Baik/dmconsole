...
const CustomInput = styled(InputBase)(({ theme, width, height, fontSize }) => ({
    '& .MuiInputBase-input': {
        ...
        borderRadius: 10,
        position: 'relative',
        backgroundColor: theme?.palette?.background?.paper || 'var(--white)',
...
// CustomImgSelect Component
const CustomImgSelect = ({
    name,  // name 속성 추가
    id,    // id 속성 추가
    label,
    value,
        ...
        <FormControl variant="outlined" fullWidth>
            ...
            <Select
                ...
                renderValue={(selected) => {
                    ...
                    return (
                        <img
                            src={menuItems.find((item) => item.value === selected)?.icon}
                            alt="Selected icon"
                            style={{ paddingLeft: 12, width: 46, height: 26 }}
                        />
                    );
                }}
                sx={{
            ...
            >
                ...
                {menuItems.map((item) => (
                    ...
                    >
                        ...
                        {/* 이미지 아이템 표시 */}
                        <img src={item.icon} alt={item.value} style={{ width: 46, height: 26 }} />
